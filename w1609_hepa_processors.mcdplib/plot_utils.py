...
def ieee_spines_zoom3(pylab):
    z = 3
    set_spines_look_A(pylab, outward_offset=5 * z, linewidth=1 * z, markersize=2 * z, markeredgewidth=0.5 * z)
...
def ieee_fonts_zoom3(pylab):
    ...
    rc(
        ...
        **{
            "family": "serif",
            "serif": ["Times", "Times New Roman", "Bitstream Vera Serif", "Palatino"],
            #                   'size': 16.0
        },
    )
